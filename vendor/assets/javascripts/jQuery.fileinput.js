...
$.fn.customFileInput = function(){
	...
	var fileInput = $(this)
		...
		.focus(function(){
			upload.addClass('customfile-focus').find('.btn').addClass("active");
			fileInput.data('val', fileInput.val());
		})
		.blur(function(){ 
			upload.removeClass('customfile-focus').find('.btn').removeClass("active");;
	...
	upload
		.mousemove(function(e){
            ...
            //console.log("epage", e.pageY)
            //console.log("topoffset",upload.offset().top)
            //console.log("scrolltop",$(window).scrollTop())
            //console.log("top",e.pageY - upload.offset().top + $(window).scrollTop() - 3)
		})
...
$.fn.customPhotoInput = function(){
    var upload = $(this);
    //apply events and styles for file input element
    var fileInput = $("<input type='file' multiple accept='image/*'>");
    fileInput.addClass('customfile-input') //add class for CSS
        .mouseover(function(){ upload.addClass('customfile-hover')})
        .mouseout(function(){ upload.removeClass('customfile-hover')})
        .focus(function(){
